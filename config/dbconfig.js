...
if(config.database.mlab==true){ 
  process.env.MONGODB_URI=`${config.database.dbType}://${config.database.dbUserName}:${config.database.dbPassword}@${config.database.mlabhost}:${config.database.mlabpost}/${config.database.dbName}`;
